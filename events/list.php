...
<div id="tribe-events-content" class="upcoming">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<div id="post-<?php the_ID() ?>" <?php post_class('tribe-events-event clearfix') ?> itemscope itemtype="http://schema.org/Event">
			...
			<div class="entry-content tribe-events-event-entry six columns alpha" itemprop="description">
				<?php if (has_excerpt ()): ?>
					<?php the_excerpt(); ?>
				<?php else: ?>
					<?php the_content(); ?>
			...
			<div class="tribe-events-event-list-meta three columns" itemprop="location" itemscope itemtype="http://schema.org/Place">
				<table cellspacing="0">
			...
			<div class="tribe-events-event-image three columns omega">
			<?php
