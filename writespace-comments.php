...
<h2 id="comments" class="comments-header"><?php comments_number('No Responses', 'One Response', '% Responses' );?></h2>
...
<h2 id="comments" class="comments-header">No comments.</h2>
...
<div id="comments-form" class="twelve columns offset-by-two">
